...
async function handler(req, res) {
  if (req.method === "GET") {
    ...
    if ((0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__/* .checkapiKey */ .eJ)(apikey)) {
      const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("SELECT * FROM product");
    ...
    if ((0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__/* .checkapiKey */ .eJ)(apikey)) {
      ...
      const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("INSERT INTO product (title, price, description, image, category) VALUES (?, ?, ?, ?, ?)", [title, price, description, image, category]);
...
var __webpack_exports__ = (__webpack_exec__(9970));
