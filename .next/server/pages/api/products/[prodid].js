...
async function handler(req, res) {
  if (req.method === "GET") {
    ...
    if ((0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__/* .checkapiKey */ .eJ)(apikey)) {
      const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("SELECT * FROM product WHERE id=?", prodid);
    ...
    if ((0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__/* .checkapiKey */ .eJ)(apikey)) {
      ...
      const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("UPDATE product SET title=?, price=?, description=?, image=?, category=? WHERE id=?", [title, price, description, image, category, prodid]);
    ...
    if ((0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__/* .checkapiKey */ .eJ)(apikey)) {
      ...
      const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("DELETE FROM product WHERE id=?", prodid);
      console.log(results);
      res.status(204).json(results);
    } else {
      res.status(401).json({
...
var __webpack_exports__ = (__webpack_exec__(2750));
