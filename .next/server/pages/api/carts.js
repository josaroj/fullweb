...
async function handler(req, res) {
  if (req.method === "GET") {
    ...
    if (verifiedToken && verifiedToken.role === "admin") {
      const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("SELECT * FROM cart");
    ...
    if (verifiedToken) {
      ...
      const results = await (0,_lib_db__WEBPACK_IMPORTED_MODULE_0__/* .query */ .I)("INSERT INTO cart (userid, products) VALUES (?, ?)", [verifiedToken.id, JSON.stringify(products)]);
